...
const TICKER_DATA = {
  all: [
    { name: "Bitcoin (BTC)", symbol: "₿", symbolClass: "bg-amber-500/20 text-amber-400", price: "111,250", unit: "USD", change: "+2.35%", isUp: true, sparkline: "M0 16 Q 16 14, 28 8 T 48 10 T 64 3" },
    { name: "Ethereum (ETH)", symbol: "Ξ", symbolClass: "bg-indigo-500/20 text-indigo-400", price: "4,328", unit: "USD", change: "+3.12%", isUp: true, sparkline: "M0 17 Q 20 15, 32 9 T 50 11 T 64 2" },
    { name: "VN-Index", symbol: "★", symbolClass: "bg-red-500/20 text-red-500", price: "1,682.45", unit: "", change: "+0.84%", isUp: true, sparkline: "M0 15 Q 18 13, 30 7 T 52 9 T 64 4" },
    { name: "HNX-Index", symbol: "H", symbolClass: "bg-sky-500/20 text-sky-400", price: "280.37", unit: "", change: "+0.62%", isUp: true, sparkline: "M0 14 Q 22 12, 34 8 T 54 10 T 64 5" },
    { name: "Giá vàng (SJC)", symbol: "🪙", symbolClass: "bg-amber-500/20 text-amber-400", price: "135,800,000", unit: "VND", change: "-0.37%", isUp: false, sparkline: "M0 5 Q 16 8, 30 13 T 48 11 T 64 16" },
    { name: "USD/VND", symbol: "$", symbolClass: "bg-blue-500/20 text-blue-400", price: "24,620", unit: "", change: "+0.05%", isUp: true, sparkline: "M0 12 Q 20 12, 35 11 T 50 10 T 64 9" }
  ],
  crypto: [
    { name: "Bitcoin (BTC)", symbol: "₿", symbolClass: "bg-amber-500/20 text-amber-400", price: "111,250", unit: "USD", change: "+2.35%", isUp: true, sparkline: "M0 16 Q 16 14, 28 8 T 48 10 T 64 3" },
    { name: "Ethereum (ETH)", symbol: "Ξ", symbolClass: "bg-indigo-500/20 text-indigo-400", price: "4,328", unit: "USD", change: "+3.12%", isUp: true, sparkline: "M0 17 Q 20 15, 32 9 T 50 11 T 64 2" },
    { name: "Solana (SOL)", symbol: "◎", symbolClass: "bg-purple-500/20 text-purple-400", price: "214.50", unit: "USD", change: "+5.80%", isUp: true, sparkline: "M0 18 Q 18 12, 36 7 T 52 5 T 64 2" },
    { name: "BNB", symbol: "B", symbolClass: "bg-yellow-500/20 text-yellow-400", price: "642.10", unit: "USD", change: "+1.45%", isUp: true, sparkline: "M0 14 Q 22 13, 38 10 T 54 8 T 64 5" },
    { name: "Ripple (XRP)", symbol: "✕", symbolClass: "bg-sky-500/20 text-sky-400", price: "0.625", unit: "USD", change: "+0.95%", isUp: true, sparkline: "M0 12 Q 24 14, 40 10 T 54 8 T 64 6" },
    { name: "Cardano (ADA)", symbol: "₳", symbolClass: "bg-blue-500/20 text-blue-400", price: "0.482", unit: "USD", change: "-0.42%", isUp: false, sparkline: "M0 6 Q 20 9, 36 12 T 50 14 T 64 17" }
  ],
  stocks: [
    { name: "VN-Index", symbol: "★", symbolClass: "bg-red-500/20 text-red-500", price: "1,682.45", unit: "", change: "+0.84%", isUp: true, sparkline: "M0 15 Q 18 13, 30 7 T 52 9 T 64 4" },
    { name: "VN30-Index", symbol: "30", symbolClass: "bg-red-500/20 text-red-500", price: "1,745.20", unit: "", change: "+1.02%", isUp: true, sparkline: "M0 16 Q 16 11, 32 7 T 50 6 T 64 3" },
    { name: "HNX-Index", symbol: "H", symbolClass: "bg-sky-500/20 text-sky-400", price: "280.37", unit: "", change: "+0.62%", isUp: true, sparkline: "M0 14 Q 22 12, 34 8 T 54 10 T 64 5" },
    { name: "S&P 500", symbol: "US", symbolClass: "bg-blue-500/20 text-blue-400", price: "5,980.25", unit: "USD", change: "+0.45%", isUp: true, sparkline: "M0 13 Q 20 12, 38 9 T 52 7 T 64 5" },
    { name: "Nasdaq 100", symbol: "NQ", symbolClass: "bg-blue-500/20 text-blue-400", price: "19,240.10", unit: "USD", change: "+0.78%", isUp: true, sparkline: "M0 15 Q 18 10, 36 8 T 52 6 T 64 3" },
    { name: "Nikkei 225", symbol: "JP", symbolClass: "bg-rose-500/20 text-rose-400", price: "39,120.50", unit: "JPY", change: "-0.15%", isUp: false, sparkline: "M0 7 Q 18 9, 36 11 T 50 13 T 64 15" }
  ],
  gold: [
    { name: "Giá vàng (SJC)", symbol: "🪙", symbolClass: "bg-amber-500/20 text-amber-400", price: "135,800,000", unit: "VND", change: "-0.37%", isUp: false, sparkline: "M0 5 Q 16 8, 30 13 T 48 11 T 64 16" },
    { name: "Vàng Nhẫn 9999", symbol: "💍", symbolClass: "bg-amber-500/20 text-amber-400", price: "132,400,000", unit: "VND", change: "+0.12%", isUp: true, sparkline: "M0 13 Q 20 12, 36 10 T 52 9 T 64 7" },
    { name: "Vàng PNJ", symbol: "P", symbolClass: "bg-yellow-500/20 text-yellow-400", price: "133,000,000", unit: "VND", change: "-0.10%", isUp: false, sparkline: "M0 8 Q 20 10, 38 12 T 52 13 T 64 15" },
    { name: "Vàng Thế Giới", symbol: "oz", symbolClass: "bg-amber-500/20 text-amber-400", price: "2,684.50", unit: "USD/oz", change: "+0.55%", isUp: true, sparkline: "M0 15 Q 18 12, 34 8 T 50 7 T 64 4" },
    { name: "Bạc Thế Giới", symbol: "Ag", symbolClass: "bg-slate-500/20 text-slate-300", price: "32.40", unit: "USD/oz", change: "+1.20%", isUp: true, sparkline: "M0 16 Q 20 14, 38 9 T 54 8 T 64 3" },
    { name: "Bạch Kim", symbol: "Pt", symbolClass: "bg-slate-400/20 text-slate-200", price: "985.00", unit: "USD/oz", change: "+0.35%", isUp: true, sparkline: "M0 12 Q 22 11, 38 9 T 52 8 T 64 6" }
  ],
  commodities: [
    { name: "Dầu Brent", symbol: "🛢️", symbolClass: "bg-slate-500/20 text-slate-300", price: "74.80", unit: "USD", change: "-0.85%", isUp: false, sparkline: "M0 6 Q 20 9, 36 13 T 50 14 T 64 18" },
    { name: "Dầu WTI", symbol: "🛢️", symbolClass: "bg-slate-500/20 text-slate-300", price: "71.20", unit: "USD", change: "-0.92%", isUp: false, sparkline: "M0 5 Q 18 8, 34 12 T 52 15 T 64 19" },
    { name: "Khí Tự Nhiên", symbol: "🔥", symbolClass: "bg-sky-500/20 text-sky-400", price: "2.65", unit: "USD", change: "+1.80%", isUp: true, sparkline: "M0 16 Q 18 12, 34 8 T 50 7 T 64 3" },
    { name: "Đồng (Copper)", symbol: "Cu", symbolClass: "bg-amber-600/20 text-amber-500", price: "4.45", unit: "USD/lb", change: "+0.65%", isUp: true, sparkline: "M0 14 Q 22 13, 38 9 T 52 8 T 64 5" },
    { name: "Đậu Tương", symbol: "🌱", symbolClass: "bg-emerald-500/20 text-emerald-400", price: "1,040.50", unit: "USD", change: "-0.25%", isUp: false, sparkline: "M0 8 Q 20 10, 38 12 T 50 14 T 64 16" },
    { name: "Cà phê Robusta", symbol: "☕", symbolClass: "bg-amber-800/20 text-amber-600", price: "4,820", unit: "USD/tấn", change: "+2.15%", isUp: true, sparkline: "M0 17 Q 16 13, 32 8 T 50 6 T 64 2" }
  ],
  forex: [
    { name: "USD/VND", symbol: "$", symbolClass: "bg-blue-500/20 text-blue-400", price: "24,620", unit: "", change: "+0.05%", isUp: true, sparkline: "M0 12 Q 20 12, 35 11 T 50 10 T 64 9" },
    { name: "EUR/VND", symbol: "€", symbolClass: "bg-blue-500/20 text-blue-400", price: "27,150", unit: "", change: "-0.18%", isUp: false, sparkline: "M0 7 Q 18 9, 36 12 T 52 13 T 64 15" },
    { name: "JPY/VND", symbol: "¥", symbolClass: "bg-rose-500/20 text-rose-400", price: "168.40", unit: "", change: "+0.22%", isUp: true, sparkline: "M0 13 Q 22 12, 38 10 T 52 9 T 64 7" },
    { name: "GBP/VND", symbol: "£", symbolClass: "bg-purple-500/20 text-purple-400", price: "32,450", unit: "", change: "+0.12%", isUp: true, sparkline: "M0 12 Q 20 11, 36 10 T 52 9 T 64 8" },
    { name: "AUD/VND", symbol: "A$", symbolClass: "bg-emerald-500/20 text-emerald-400", price: "16,380", unit: "", change: "-0.05%", isUp: false, sparkline: "M0 9 Q 20 10, 36 11 T 50 12 T 64 14" },
    { name: "CNY/VND", symbol: "元", symbolClass: "bg-red-500/20 text-red-400", price: "3,460", unit: "", change: "+0.02%", isUp: true, sparkline: "M0 11 Q 20 11, 36 11 T 52 10 T 64 10" }
  ],
  rates: [
    { name: "Lãi suất Fed", symbol: "FED", symbolClass: "bg-blue-500/20 text-blue-400", price: "4.75 - 5.00%", unit: "", change: "-25 bps", isUp: false, sparkline: "M0 6 Q 22 10, 38 12 T 52 14 T 64 17" },
    { name: "Lãi suất ECB", symbol: "ECB", symbolClass: "bg-blue-500/20 text-blue-400", price: "3.25%", unit: "", change: "-25 bps", isUp: false, sparkline: "M0 7 Q 20 10, 36 12 T 50 13 T 64 16" },
    { name: "Lãi suất NHNN", symbol: "SBV", symbolClass: "bg-red-500/20 text-red-500", price: "4.50%", unit: "", change: "0.00%", isUp: true, sparkline: "M0 10 Q 20 10, 36 10 T 52 10 T 64 10" },
    { name: "Liên ngân hàng", symbol: "ON", symbolClass: "bg-emerald-500/20 text-emerald-400", price: "3.85%/năm", unit: "", change: "+0.15%", isUp: true, sparkline: "M0 13 Q 22 12, 38 10 T 52 9 T 64 7" },
    { name: "Tiết kiệm 12T", symbol: "12M", symbolClass: "bg-yellow-500/20 text-yellow-400", price: "5.60%/năm", unit: "", change: "0.00%", isUp: true, sparkline: "M0 10 Q 20 10, 36 10 T 52 10 T 64 10" },
    { name: "TPCP Mỹ 10Y", symbol: "10Y", symbolClass: "bg-purple-500/20 text-purple-400", price: "4.15%", unit: "", change: "-0.04%", isUp: false, sparkline: "M0 8 Q 20 10, 36 11 T 50 13 T 64 15" }
  ]
};
...
function handleGlobalSearch(e) {
  ...
  const articles = typeof allLoadedArticles !== "undefined" ? allLoadedArticles : [];
  const matches = articles.filter((art) => {
    ...
    return title.includes(query) || heading.includes(query) || cat.includes(query) || content.includes(query);
  });
  ...
  resultsContainer.innerHTML = matches
    .map((art) => {
      ...
      const date = art.postDate || (art.createdAt ? formatVietnameseDate(art.createdAt) : "");
      return `
        <div
...
function renderDynamicHeroSlides(banners) {
  ...
  banners.forEach((banner, idx) => {
    ...
    const scriptColorClass = escapeText(banner.scriptColor || "text-slate-200/90");
  ...
  // 4. Update Indicators
  const indicatorsContainer = document.getElementById("heroIndicatorsContainer");
...
async function loadHeroBanners() {
  ...
  try {
    ...
    console.warn("Could not load dynamic banners from API, falling back to static slides:", err.message);
  } finally {
    initHeroSlideshow();
  }
}
  ...
  if (indicatorsContainer) {
    ...
    pills.forEach((pill, idx) => {
      if (idx === currentHeroIndex) {
        ...
        pill.className = "indicator-pill w-2 h-2 rounded-full bg-white/40 hover:bg-white/75";
      }
    });
  }
